<div class="w3-bar w3-theme w3-top-menu">
	...
	<div class="w3-container w3-left">
		...
		<?php foreach($top_menu as $menu_item): ?>
			<a class="w3-bar-item w3-button w3-padding-16" href="<?php echo $menu_item->uri; ?>" target="<?php echo $menu_item->target; ?>" title="<?php echo $menu_item->display_name; ?>"><?php echo $menu_item->display_name; ?></a>
		<?php endforeach; } ?>
	</div>
</div>
