<!-- Header -->
<header class="w3-container w3-theme w3-center w3-padding-0" id="siteHeader">
	<div id="w3-site-navigation" class="w3-container w3-padding-0 w3-left"><i onclick="w3_open()" class="fa fa-bars w3-xlarge w3-button w3-theme"></i></div>
